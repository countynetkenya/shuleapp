...
# Function to write placeholder spec
write_placeholder_spec() {
...
if [ -n "${OPENAI_API_KEY:-}" ]; then
  ...
  RESPONSE=$(curl -sS https://api.openai.com/v1/chat/completions \
    ...
    -d "{\"model\": \"gpt-4o-mini\", \"messages\": [{\"role\": \"user\", \"content\": \"${PROMPT_TEMPLATE}\"}], \"max_tokens\": 800, \"temperature\": 0.0}") || true
