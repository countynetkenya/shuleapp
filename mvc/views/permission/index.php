                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach ($permissions as $data) {
                                            if(strpos($data->name, '_edit') == false && strpos($data->name, '_view') == false && strpos($data->name, '_delete') == false && strpos($data->name, '_add') == false && $data->name != 'backup' && $data->name != 'frontend_setting' && $data->name != 'emailsetting' && $data->name != 'school') {
                                                $push['name'] = $data->name;
                                    ...
                                    foreach($permissionTable as $data) {
                                      if($data['name'] != "sociallink" && $data['name'] != "posts_categories" && $data['name'] != "posts" && $data['name'] != "pages" && $data['name'] != "frontendmenu" && $data['name'] != "admin") { ?>
                                        <tr>
