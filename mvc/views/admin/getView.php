<?php if(customCompute($profile)) { ?>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("admin/index")?>"><?=$this->lang->line('menu_admin')?></a></li>
    ...
    <form class="form-horizontal" role="form" action="<?=base_url('admin/send_mail');?>" method="post">
