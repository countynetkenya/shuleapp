...
<head>
    ...
    <!-- Style -->
    <link href="<?php echo base_url('assets/shuleapp/style.css'); ?>" rel="stylesheet"  type="text/css">
    <!-- iNilabs css -->
    <link href="<?php echo base_url('assets/shuleapp/inilabs.css'); ?>" rel="stylesheet"  type="text/css">
