...
class Productsaleitem_m extends MY_Model {
	...
	public function get_productsaleitem_quantity($array) {
		...
		$this->db->select('SUM(productsaleitem.productsalequantity) AS quantity, SUM(productsaleitem.productsalequantity*productsaleitem.productsaleunitprice) AS netsales, productsaleitem.productID AS productID, productwarehouseID');
